    ...
    fn render(&mut self, rows: usize, cols: usize) {
        ...
        if cols < 60 || rows < 12 {
            ...
            Paragraph::new("terminal too small (need ≥60×12)")
                .style(Style::default().fg(self.config.colors.muted))
...
impl State {
    ...
    fn render_list(&mut self, area: Rect, buf: &mut Buffer) {
        ...
        let items: Vec<ListItem> = self
            ...
            .map(|(s, m)| {
                ...
                spans.push(Span::styled(
                    ...
                    Style::default().fg(c.for_type(m.ty)),
                ));
                ...
                spans.extend(highlight_spans(&display, &s.indices, c.highlight));
        ...
        let list = List::new(items)
            ...
            .highlight_style(
                ...
                Style::default()
                    .bg(self.config.colors.cursor_bg)
                    .fg(self.config.colors.cursor_fg)
                    .add_modifier(Modifier::BOLD),
            )
            .highlight_symbol("▸ ");
    ...
    fn render_preview(&self, area: Rect, buf: &mut Buffer) {
        ...
        let c = &self.config.colors;
        let dim = Style::default().fg(c.muted);
        let gutter_style = Style::default().fg(c.muted);
    ...
    fn render_footer(&self, area: Rect, buf: &mut Buffer) {
        ...
        let dim = Style::default().fg(self.config.colors.muted);
        ...
        if let Some(m) = self.current_match() {
            ...
            line1.push(Span::styled(
                format!(" {}", m.effective_tag()),
                Style::default()
                    .fg(self.config.colors.for_type(m.ty))
                    .add_modifier(Modifier::BOLD),
            ));
            line1.push(Span::raw("  ·  "));
        ...
        if let Some(msg) = &self.message {
            ...
            line2.push(Span::styled(
                msg.clone(),
                Style::default().fg(self.config.colors.highlight),
            ));
        }
    ...
    fn render_banner(&self, area: Rect, buf: &mut Buffer) {
            ...
            Some(BannerKind::Warning(msg)) => (
                Line::from(vec![
                    ...
                    Span::styled(
                        "Warning",
                        Style::default()
                            .fg(self.config.colors.highlight)
                            .add_modifier(Modifier::BOLD),
                    ),
                    Span::raw(format!("  {msg}")),
                ]),
        ...
        Paragraph::new(vec![line1, line2])
            .block(
                Block::default()
                    .borders(Borders::ALL)
                    .border_style(Style::default().fg(self.config.colors.highlight)),
            )
            .render(area, buf);
    }
}
...
mod tests {
    ...
    fn highlight_spans_empty_indices() {
        let spans = highlight_spans("hello", &[], Color::Yellow);
    ...
    fn highlight_spans_alternating() {
        ...
        let spans = highlight_spans("abcde", &[0, 2, 4], Color::Yellow);
    ...
    fn highlight_spans_contiguous_run() {
        ...
        let spans = highlight_spans("abcde", &[1, 2, 3], Color::Yellow);
